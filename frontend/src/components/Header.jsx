...
const Header = () => {
  ...
  return (
    <div className="header mt-[3em]">
      ...
      <p className="mt-5 mb-7 w-[50%] text-base text-[#666666] leading-7">
      ...
      <Link
        className="py-3 px-4 text-base text-primary-color border-solid border-[1px] rounded-md border-primary-color outline-none hover:bg-primary-color hover:text-[#fff] transition-colors duration-150"
        to="/profile"
      >
        View Profile
      </Link>
